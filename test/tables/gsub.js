...
describe('tables/gsub.js', function () {
    ...
    it('can parse a GSUB header with null pointers', function () {
        const data = unhex('00010000 0000 0000 0000');
        assert.deepEqual(gsub.parse(data), {
            version: 1,
            scripts: [],
            features: [],
    ...
    it('can parse lookup1 substFormat 2', function () {
        ...
        const data =
            '0002 000E 0004 0131 0135 013E 0143   0001 0004 003C 0040 004B 004F';
        assert.deepEqual(parseLookup(1, data), {
            substFormat: 2,
            coverage: {
                format: 1,
    ...
    it('can parse lookup2', function () {
        ...
        const data =
            '0001 0008 0001 000E   0001 0001 00F1   0003 001A 001A 001D';
    ...
    it('can parse lookup4', function () {
        ...
        const data =
            '0001 000A 0002 0014 0020' + // LigatureSubstFormat1
    ...
    it('can parse lookup5 substFormat 2', function () {
        ...
        const data =
            '0002 0010 001C 0004 0000 0000 0032 0040' + // ContextSubstFormat2
            ...
            coverages: [
                {
                    format: 1,
                    glyphs: [
                        0x33, 0x35, 0x37, 0x38, 0x39, 0x3b, 0x3c, 0x3d, 0x41,
                        0x42, 0x45, 0x4a,
                    ],
                },
                {
                    format: 1,
                    glyphs: [
                        0x32, 0x34, 0x36, 0x3a, 0x3e, 0x3f, 0x40, 0x43, 0x44,
                        0x45, 0x46, 0x47, 0x48, 0x49, 0x4b,
                    ],
                },
                {
                    format: 1,
    ...
    it('can parse lookup8', function () {
        ...
        const data =
            '0001 0068 0001 0000 0001 0026 000C 00A7 00B9 00C5 00D4 00EA 00F2 00FD 010D 011B 012B 013B 0141' + // ReverseChainSingleSubstFormat1
        ...
        assert.deepEqual(parsed, {
            ...
            coverage: {
                format: 1,
                glyphs: [
                    0xa6, 0xb7, 0xc3, 0xd2, 0xe9, 0xf1, 0xfc, 0x10c, 0x119,
                    0x129, 0x13a, 0x140,
                ],
            },
            ...
            lookaheadCoverage: [
                {
                    format: 1,
                    glyphs: [
                        0xa5, 0xa9, 0xaa, 0xe2, 0x167, 0x168, 0x169, 0x16d,
                        0x16e, 0x170, 0x183, 0x184, 0x185, 0x189, 0x18a, 0x18c,
                        0x19f, 0x1a0, 0x1a1, 0x1a2, 0x1a3, 0x1a4, 0x1a5, 0x1a6,
                        0x1a7, 0x1a8, 0x1a9, 0x1aa, 0x1ab, 0x1ac, 0x1ec,
                    ],
                },
            ],
            substitutes: [
                0xa7, 0xb9, 0xc5, 0xd4, 0xea, 0xf2, 0xfd, 0x10d, 0x11b, 0x12b,
                0x13b, 0x141,
            ],
        });
    });
    ...
    /// Writing ///////////////////////////////////////////////////////////////
    it.skip('should write a simple GSUB table + lookup type 4', function () {
    ...
    it.skip('can write a lookup with coverage table format 2', function () {
        ...
        const expectedData = unhexArray(
            '0001 0006 00C0   0002 0003   0019 001A 0000   004E 0057 0002   0060 0063 000C'
        );
        assert.deepEqual(
            makeLookup(1, {
                substFormat: 1,
    ...
    //// Lookup type 1 ////////////////////////////////////////////////////////
    it.skip('can write lookup1 substFormat 1', function () {
        const expectedData = unhexArray(
            '0001 0006 00C0   0001 0004 003C 0040 004B 004F'
        );
        assert.deepEqual(
            makeLookup(1, {
                substFormat: 1,
    ...
    it.skip('can write lookup1 substFormat 2', function () {
        // https://www.microsoft.com/typography/OTSPEC/GSUB.htm#EX3
        const expectedData = unhexArray(
            '0002 000E 0004 0131 0135 013E 0143   0001 0004 003C 0040 004B 004F'
        );
    ...
    //// Lookup type 2 ////////////////////////////////////////////////////////
    it.skip('can write lookup2', function () {
        // https://www.microsoft.com/typography/OTSPEC/GSUB.htm#EX4
        const expectedData = unhexArray(
            '0001 0008 0001 000E   0001 0001 00F1   0003 001A 001A 001D'
        );
    ...
    //// Lookup type 3 ////////////////////////////////////////////////////////
    it.skip('can write lookup3', function () {
        // https://www.microsoft.com/typography/OTSPEC/GSUB.htm#EX5
        const expectedData = unhexArray(
            '0001 0008 0001 000E   0001 0001 003A   0002 00C9 00CA'
        );
        assert.deepEqual(
            makeLookup(3, {
                substFormat: 1,
    ...
    //// Lookup type 6 ////////////////////////////////////////////////////////
    it.skip('can write lookup6 substFormat1', function () {
    ...
    it.skip('can write lookup6 substFormat1 with all rule set properties', function () {
    ...
    it.skip('can write lookup6 substFormat3', function () {
